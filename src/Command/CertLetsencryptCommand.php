...
namespace Cert\LetsEncryptBundle\Command;
...
class CertLetsencryptCommand extends ContainerAwareCommand
{
    /**
     * @var OutputInterface
     */
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $script = $this->container->getParameter('cert_lets_encrypt.letsencrypt');
        $domains = $this->container->getParameter('cert_lets_encrypt.domains');
        $recoveryMail = $this->container->getParameter('cert_lets_encrypt.recovery_email');
        $logDir = $this->container->getParameter('cert_lets_encrypt.logs_directory');
